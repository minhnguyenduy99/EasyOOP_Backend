const o =
{
    ...
    txt_ExerciseReady: "Đã hiểu, bắt đầu ngay!",
    ...
    txt_ExerciseHelp3: `Nhấn nút "%s" để nộp bài`,
    txt_ExerciseHelp4: `nút "%s" chuyển sang danh sách câu hỏi trước đó và "%s" cho danh sách câu hỏi kế tiếp.`,
    ...
    get: function (stringOrTxt: string, ...args) {
        ...
        args.forEach(e => s = s.replace(/%s/g, () => e))
        return s
    }
}
export default o